defmodule SpermWhaleWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SpermWhaleWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/sperm_whale_web/templates",
        namespace: SpermWhaleWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SpermWhaleWeb.LayoutView, "live.html"}
